...
import sys
sys.path.insert(0, '../')
from execute_locator import execute_locator, \
                            execute_action, \
...
class TestExecuteLocator(unittest.TestCase):
    ...
    def test_execute_action(self):
        ...
        result = execute_locator(self.mock_driver, locator)
        self.assertEqual(result, execute_action(self.mock_driver, locator))
    ...
    def test_execute_multiple_actions(self):
        ...
        result = execute_locator(self.mock_driver, locator)
        self.assertEqual(result, [execute_action(self.mock_driver, {'action': 'move_to_element', 'attribute': 'class', 'by': 'class_name', 'selector': 'example'}),
                                  execute_action(self.mock_driver, {'action': 'click', 'attribute': 'class', 'by': 'class_name', 'selector': 'example'})])
    ...
    def test_execute_nested_locator(self):
        ...
        result = execute_locator(self.mock_driver, locator)
        self.assertEqual(result, [execute_action(self.mock_driver, {'action': 'move_to_element', 'attribute': 'class', 'by': 'class_name', 'selector': 'parent'}),
                                  execute_action(self.mock_driver, {'action': 'click', 'attribute': 'class', 'by': 'class_name', 'selector': 'example'})])
...
class TestGetAttributesFromWebElementsByLocator(unittest.TestCase):
    ...
    def test_attribute_is_dict(self):
        ...
        locator = {"by": "id", "selector": "some_id", "action": None,
    ...
    def test_attribute_is_list(self):
        ...
        driver.get_attribute = MagicMock(return_value='foo')
        locator = {"by": "id", "selector": "some_id",
                   "action": None, "attribute": ["attr1", "attr2"]}
...
class TestGetWebElementsFromPage(unittest.TestCase):
