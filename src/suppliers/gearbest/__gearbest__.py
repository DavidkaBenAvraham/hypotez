...
import settings 
from src.settings import SF as SF
...
def login(s) -> bool :
    ...
    def _set_language_currency_shipto():
        ...
        except Exception as ex: return False, print(f'''{ex.with_traceback(ex.__traceback__)} не получилось выбрать язык/страну/валюту''')
