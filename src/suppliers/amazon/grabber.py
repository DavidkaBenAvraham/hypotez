...
def field_description():
	...
	#descr = d.execute_locator (l['description'] ) [0]
...
def field_description_short():
	...
	@details
	"""
	return str ( d.execute_locator (l['description_short'] )[0] )
	pass
...
def field_name(product_name: str) -> str:
	...
	"""
	return SN.normalize_product_name (d.execute_locator (l['name'])[0] )
	pass
...
def field_price():
	...
	@details
	"""
	return SN.normalize_price ( d.execute_locator ( l['price']['new'])[0] ) 
...
def field_supplier_reference():
	...
	"""
	return d.execute_locator (l['ASIN'])
	pass
