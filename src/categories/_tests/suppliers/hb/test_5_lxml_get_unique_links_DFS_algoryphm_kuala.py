...
import header
from header import pprint, jprint, logger
import requests
import re
import json
...
def get_unique_links(response, visited_links):
    ...
    # Выполняем поиск ссылок на странице, исключая адрес "https://hbdeadsea.co.il/product-category/allproducts/"
...
def get_link_name(response, url):
    ...
    # Выполняем поиск текста ссылки на странице
