...
class GSRender():
    ...
    def render_header (self, ws: Worksheet, world_title: str, range: str = 'A1:Z1', merge_type: Union [str('MERGE_ALL'), str('MERGE_COLUMNS'), str('MERGE_ROWS') ] = 'MERGE_ALL' ) -> None:
        """
        ...
        Parameters : 
             ...
             merge_type : Union[str('MERGE_ALL'),str('MERGE_COLUMNS'),str('MERGE_ROWS')] = 'MERGE_ALL' : 'MERGE_ALL' | 'MERGE_COLUMNS' | 'MERGE_ROWS'
        Returns : 
             None : [description]
    ...
    def merge_range (self, ws: Worksheet, range: str, merge_type: Union [str('MERGE_ALL'), str('MERGE_COLUMNS'), str('MERGE_ROWS') ] =  'MERGE_ALL') -> None:
        """
         [Function's description]
        ...
        Parameters : 
             ...
             merge_type : Union[str('MERGE_ALL'),str('MERGE_COLUMNS'),str('MERGE_ROWS')] = 'MERGE_ALL' : [description]
        Returns : 
             None : [description]
    ...
    def set_worksheet_direction (self, sh: Spreadsheet, ws: Worksheet, direction: Union[str ('ltr'), str ('rtl')] = 'rtl' ):
        """
         [Function's description]
        ...
        Parameters : 
             ...
             ws : Worksheet : [description]
             direction : Union[str('ltr'),str('rtl')] = 'rtl' : [description]
...
################################################################################################################
    ...
    def header(self, ws: Worksheet, ws_header: Union[str, list], row: int = None):
        """
         [Function's description]
        ...
        Parameters : 
             self : [description]
             ws : Worksheet : [description]
             ws_header : Union[str,list] : [description]
    ...
    def write_category_title (self, ws: Worksheet, ws_category_title: Union[str, list], row: int = None):
        """
         [Function's description]
        ...
        Parameters : 
             self : [description]
             ws : Worksheet : [description]
             ws_category_title : Union[str,list] : [description]
             row : int = None : [description]
