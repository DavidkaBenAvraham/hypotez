"""! @ru_brief Класс `Product`. Взаимодействие  сайт <--> товар <--> престашоп
@ru_details Определяет поведение товара в проекте. 
...
class Product():
    """! @ru_brief Манипуляции с товаром.
    @ru_details Вначале я отдаю грабберу комманду забрать данные со страницы товара,
    ...
    """@ru_note Я могу передать локаторы товара из сценария или изменить их на лету """
