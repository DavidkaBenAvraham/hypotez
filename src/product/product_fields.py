...
@namespace src.product.product_fields
...
#   4   Главная категория этого товара
    ...
    def field_id_category_default(self) -> int:
        ...
        """
        return self.id_category_default
    ...
    def field_id_category_default(self, value: int):
        ...
        try:
            self.id_category_default = value
...
# дополнительные, которые записываются в ключе associations['categories']  
    ...
    def field_additional_categories(self) -> Union [dict, False]:
        ...
        return self.associations['categories'] or False
    ...
    def field_additional_categories(self, value: Union[int,list[int]]):
        ...
        try:
            ...
            if 'associations' not in self.fields.keys():
                self.associations.update('associations')
            if 'categories' not in self.fields['associations'].keys():
                self.associations['associations'].update('categories')
                self.associations['categories']: dict = additional_categories_dict
                """! Всякие дополнения идут через ключ `assotiations` """
            else:
                self.associations['categories']: dict = additional_categories_append(s, value)
...
#             self.associations['categories']['category'].append ( [{'id': id} for id in additional_categories] )
#         except ProductFieldException as ex:
...
#   7   Распродажа - Mivtza
    ...
    #@logs_and_errors_decorator (default_return =  False)    
    def field_on_sale(self, value: int ):
...
#   8 online_only: только через онлайн
    ...
    #@logs_and_errors_decorator (default_return =  False)
    def field_online_only(self, value: int = 0) -> bool:
        """!   <sub>*[setter]*</sub> """
        try:
...
#   9   ean13
    ...
    @field_ean13.setter
    #@logs_and_errors_decorator (default_return =  False)
    def field_ean13(self, value) -> bool:
...
#   10
    ...
    @field_isbn.setter
    #@logs_and_errors_decorator (default_return =  False)
    def field_isbn(self, value: str = None) -> bool:
        """!   <sub>*[setter]*</sub>   `isbn`
        field DB type: varchar(32)
        @russian @details: __prod_desc__"""
        try:
...
#   11
    ...
    @field_upc.setter
    #@logs_and_errors_decorator (default_return =  False)
    def field_upc(self, value: str = None) -> Union[str, None]:
...
#   12  mpn
    ...
    @field_mpn.setter
    #@logs_and_errors_decorator (default_return =  False)
    def field_mpn(self, value: str = None) -> bool:
        """!   <sub>*[setter]*</sub>  """
        try:
            self.mpn = value
            return True
...
#   19
    ...
    #@logs_and_errors_decorator (default_return =  False)
    def field_wholesale_price(self, value: str = None) -> float:
        """!  <sub>*[setter]*</sub>   """
        try:
            self.wholesale_price = str(SN.normalize_price(
                value))
            return True
        except ProductFieldException as ex:
            logger.error(f"""
...
#   20
    ...
    @field_unity.setter
    #@logs_and_errors_decorator (default_return =  False)
    def field_unity(self, value: str = None) -> bool:
        """!  <sub>*[setter]*</sub>   """
        try:
            self.unity = value
            return True
...
#   22
    ...
    def field_additional_shipping_cost(self) -> float:
        ...
        field DB type: decimal(20,6)
        @russian @details: __prod_desc__"""
        return self.additional_shipping_cost
    ...
    def field_additional_shipping_cost(self, value: int = 1) -> bool:
        """!  <sub>*[setter]*</sub>   """
        try:
            self.additional_shipping_cost = value
            return True
        except ProductFieldException as ex:
            logger.error(f"""
...
#   23
    ...
    #@logs_and_errors_decorator (default_return =  False)
    def field_reference(self, value: str) -> bool:
        """!  <sub>*[setter]*</sub>   """
        try:
...
#   24
    ...
    #@logs_and_errors_decorator (default_return =  False)
    def field_supplier_reference(self, value: str = None) -> bool:
        """!  <sub>*[setter]*</sub>   """
        try:
            self.supplier_reference = str(value)
            return True
        except ProductFieldException as ex:
            logger.error(f"""
...
#   25
    ...
    #@logs_and_errors_decorator (default_return =  False)
    def field_location(self, value: str = None) -> bool:
        """!  <sub>*[setter]*</sub>   """
        try:
...
#   29
  ...
  #  31
    ...
    def field_additional_delivery_times(self) -> int:
        ...
        @russian @details: __prod_desc__"""
        return self.additional_delivery_times
    ...
    def field_additional_delivery_times(self, value: int = 0) -> bool:
        """!  <sub>*[setter]*</sub>   """
        try:
            self.additional_delivery_times = value
            return True
        except ProductFieldException as ex:
            logger.error(f"""
...
#  36
    ...
    @field_active.setter
    #@logs_and_errors_decorator (default_return =  False)
    def field_active(self, value: int = 0) -> bool:
        """!  <sub>*[setter]*</sub>   """
        try:
            self.active = value
            return True
...
#  37
 ...
 #  38
    ...
    def field_id_type_redirected(self) -> int:
        ...
        return self.id_type_redirected
 ...
 #  39
    ...
    def field_available_for_order(self) -> int:
        ...
        return self.available_for_order
    ...
    def field_available_for_order(self, value: int = 0) -> bool:
        """!  <sub>*[setter]*</sub>   """
        try:
            self.available_for_order = value
            return True
        except ProductFieldException as ex:
            logger.error(f"""
...
#  47
    ...
    def field_cache_has_attachments(self) -> int:
        ...
        return self.cache_has_attachments
    ...
    def field_cache_has_attachments(self, value: int = 1) -> bool:
        """!  <sub>*[setter]*</sub>   """
        try:
            self.cache_has_attachments = value
            return True
        except ProductFieldException as ex:
            logger.error(f"""
...
#  49
    ...
    def field_cache_default_attribute(self) -> int:
        ...
        return self.cache_default_attribute
    ...
    def field_cache_default_attribute(self, value: int = 1) -> bool:
        """!  <sub>*[setter]*</sub>   """
        try:
            self.cache_default_attribute = value
            return True
        except ProductFieldException as ex:
            logger.error(f"""
...
#  52
    ...
    def field_advanced_stock_management(self) -> int:
        ...
        return self.advanced_stock_management
    ...
    def field_advanced_stock_management(self, value: int = 0) -> bool:
        """!  <sub>*[setter]*</sub>   """
        try:
            self.advanced_stock_management = value
            return True
        except ProductFieldException as ex:
            logger.error(f"""
...
#   4
    ...
    #@logs_and_errors_decorator (default_return =  False)
    def field_description(self, value: str = None) -> bool:
        """!  <sub>*[setter]*</sub>   """
        try:
...
#   5
    ...
    #@logs_and_errors_decorator (default_return =  False)
    def field_description_short(self, value: str = None) -> bool:
        """!  <sub>*[setter]*</sub>   """
        try:
            self.description_short: dict = {
                "language":[
                {'attrs':{'id':'1'}, 'value':value},
                {'attrs':{'id':'2'}, 'value':value},
                {'attrs':{'id':'3'}, 'value':value},
...
#   6
    ...
    def field_link_rewrite(self) -> str:
        ...
        description: __prod_desc__"""
        return self.link_rewrite

    
    @field_link_rewrite.setter
    #@logs_and_errors_decorator (default_return =  False)
    def field_link_rewrite(self, value: str = None) -> bool:
        """!  <sub>*[setter]*</sub>   """
        try:
...
#   14
    ...
    def field_delivery_out_stock(self) -> str:
        ...
        description: __prod_desc__"""
        return self.delivery_out_stock
...
#   15
    ...
    def field_delivery_additional_message(self) -> str:
        ...
        field DB type: 
        description: __prod_desc__"""
        return self.delivery_additional_message
    ...
    def field_delivery_additional_message(self, value=None) -> bool:
        ...
        """
        try:
            self.delivery_additional_message: dict = {
                "language":[
                {'attrs':{'id':'1'}, 'value':value},
                {'attrs':{'id':'2'}, 'value':value},
                {'attrs':{'id':'3'}, 'value':value},
...
#   16
    ...
    def field_affiliate_short_link(self) -> dict:
        ...
        description: __prod_desc__"""
        return self.affiliate_short_link
    
    @field_affiliate_short_link.setter
    #@logs_and_errors_decorator (default_return =  False)
    def field_affiliate_short_link(self, value:str) -> bool:
        ...
        """
        try:
            self.affiliate_short_link: dict = {
                "language":[
                {'attrs':{'id':'1'}, 'value':value},
                {'attrs':{'id':'2'}, 'value':value},
                {'attrs':{'id':'3'}, 'value':value},
...
#   18
    ...
    def field_affiliate_summary_2(self) -> str:
        ...
        return self.affiliate_summary_2

    
    @field_affiliate_summary_2.setter
    #@logs_and_errors_decorator (default_return =  False)
    def field_affiliate_summary_2(self, value: str = None) -> bool:
        """!  <sub>*[setter]*</sub>   """
        try:
            self.affiliate_summary_2: dict = {
            "language":[
            {'attrs':{'id':'1'}, 'value':value},
            {'attrs':{'id':'2'}, 'value':value},
            {'attrs':{'id':'3'}, 'value':value},
...
#   20
    ...
    def field_affiliate_image_small(self) -> str:
        """!  <sub>*[property]*</sub>  `ps_product_lang.affiliate_summary_2`"""
        return self.affiliate_image_small

    
    @field_affiliate_image_small.setter
    #@logs_and_errors_decorator (default_return =  False)
    def field_affiliate_image_small(self, value: str = None) -> bool:
        """!  <sub>*[setter]*</sub>   """
        try:
            self.affiliate_image_small: dict = {
            "language":[
            {'attrs':{'id':'1'}, 'value':value},
            {'attrs':{'id':'2'}, 'value':value},
            {'attrs':{'id':'3'}, 'value':value},
 ...
 #   21
    ...
    def field_affiliate_image_medium(self) -> str:
        """!  <sub>*[property]*</sub>  `ps_product_lang.affiliate_summary_2`"""
        return self.affiliate_image_medium

    
    @field_affiliate_image_medium.setter
    #@logs_and_errors_decorator (default_return =  False)
    def field_affiliate_image_medium(self, value: str = None) -> bool:
        """!  <sub>*[setter]*</sub>   """
        try:
            self.affiliate_image_medium: dict = {
            "language":[
            {'attrs':{'id':'1'}, 'value':value},
            {'attrs':{'id':'2'}, 'value':value},
            {'attrs':{'id':'3'}, 'value':value},
 ...
 #   22
    ...
    #@logs_and_errors_decorator (default_return =  False)
    def field_affiliate_image_large(self, value: str = None) -> bool:
        """!  <sub>*[setter]*</sub>   """
        try:
            self.affiliate_image_medium: dict = {
            "language":[
...
# 23
    ...
    #@logs_and_errors_decorator (default_return =  False)
    def field_ingridients(self, ingridients: str = None) -> bool:
        ...
        try:
            ...
            logger.error(f'Ошибка заполнения `ingridients` данными {ingridients} Ошибка:', ex)
            return False
    ...
    #@logs_and_errors_decorator (default_return =  False)
    def field_how_to_use(self, how_to_use: str = None) -> bool:
        """!  <sub>*[setter]*</sub>  `ps_product_lang.how_to_use` """
        try:
            self.how_to_use: dict = {
            "language":[
    ...
    def url_default_image(self, url_default_image: int) -> bool:
        """!  <sub>*[setter]*</sub>   """
        try:
            self.url_default_image = url_default_image
            return True
        except ProductFieldException as ex:
            logger.error(f"""Ошибка заполнения поля: 'id_default_image' данными {url_default_image}
            Ошибка:""", ex)
            return False
...
#  ---------
    ...
    def id_default_combination(self) -> str:
        ...
        return self.id_default_combination
...
#  ---------
    ...
    def position_in_category(self) -> str:
        ...
        return self.position_in_category
