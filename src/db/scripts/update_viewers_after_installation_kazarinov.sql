...
select
   *
from
    `hypotez_product_attribute_combination`;
...
select
   *
from
    `hypotez_product_attribute_image`;
...
select
   *
from
    `hypotez_product_attribute_shop`;
